            ...
            <div class="row">
                ...
                <div v-if="!colStyle" :class="colStyle ? 'col-md-6 col-sm-6' : 'col-md-4'">
                    <div class="form-group">
                        ...
                        <input v-model="newLoginInformation.currentPassword" type="password" class="form-control" />
                    </div>
                </div>
                <div :class="colStyle ? 'col-md-6 col-sm-6' : 'col-md-4'">
                    <div class="form-group">
                        <label>New Password</label>
                        <input v-model="newLoginInformation.password" type="password" class="form-control" />
                    </div>
                </div>
            </div>
...
export default {
    ...
    mounted() {
        ...
        console.log(this.newLoginInformation)
    },
    data() {
        return {
            newLoginInformation: {
